<p align="center"><a href="https://github.com/Tingfe/lx-music-car"><img width="200" src="https://github.com/lyswhut/lx-music-mobile/blob/master/doc/images/icon.png" alt="lx-music logo"></a></p>

<h1 align="center">LX Music 车机版</h1>

<p align="center">
  <a href="https://github.com/Tingfe/lx-music-car/releases"><img src="https://img.shields.io/github/release/Tingfe/lx-music-car" alt="Release version"></a>
  <a href="https://github.com/Tingfe/lx-music-car/actions/workflows/release.yml"><img src="https://github.com/Tingfe/lx-music-car/actions/workflows/release.yml/badge.svg" alt="Build status"></a>
...
<p align="center">面向 Android 车机的横屏音乐播放器</p>
...
软件变化请查看[更新日志](https://github.com/Tingfe/lx-music-car/blob/master/CHANGELOG.md)。

软件下载请查看 [GitHub Releases](https://github.com/Tingfe/lx-music-car/releases)。

使用常见问题请参阅[移动版常见问题](https://lyswhut.github.io/lx-music-doc/mobile/faq)。

本项目的发布地址为 [Tingfe/lx-music-car Releases](https://github.com/Tingfe/lx-music-car/releases)。
...
- 独立仓库、独立 APK 与独立更新地址：`Tingfe/lx-music-car`。
- 保留车机版包名 `cn.toside.music.mobile.car`，可覆盖升级此前安装的车机版。
- 强制横屏、沉浸式全屏、禁止多窗口缩放；车机主页常亮。
- 车机专属驾驶舱布局：108dp 带文字的侧边导航、72dp 顶栏、90dp 播放栏、68dp 播放控制和更大的文字。
- 快速日间/夜间切换保留在主页顶栏；主题仅保存在车机本地，不会被手机或桌面端设置覆盖。

完整的布局、安装和升级说明见[车机版说明](docs/CAR_EDITION.md)。

### 同步与音源功能

- 新增自定义音源同步：同一同步账号的设备可同步「设置 → 自定义源」中导入的完整 JS 音源脚本及其元信息；原有歌单与不喜欢列表同步不受影响。
- `master` 推送会自动构建可独立安装的车机测试 APK，并以 GitHub **预发布版本（Pre-release）**展示在 Releases 页面。该 APK 内置 JavaScript bundle，不依赖电脑上的 Metro 开发服务器，也不需要配置正式签名密钥。
- 应用内「检查更新」只读取本仓库的正式 GitHub Release，并按当前车机 CPU 架构选择 APK；测试预发布版本仍需在 Releases 页面手动安装。
